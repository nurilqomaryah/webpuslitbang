<div class="container">
    <div class="row text-center">
        <div class="col-md-8">
            <a href="http://www.bpkp.go.id/"><img class="logo-img" src="{{('images/Logo New 1.png')}}" width="80%" style="float: left;"></a>
        </div>
        <div class="col-md-4">
            <img class="img-responsive" src="{{('images/tag-text.png')}}" width="55%" style="float: right; padding-top: 5%;">
        </div>
    </div>
</div>
